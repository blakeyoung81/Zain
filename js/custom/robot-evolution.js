...
const robotData = {
    foundation: {
        ...
        images: [
            ...
            { src: "https://via.placeholder.com/800x400/0088CC/FFFFFF?text=Robotics+Camp+2014", alt: "First Robotics Camp" },
            { src: "https://via.placeholder.com/800x400/FF6B35/FFFFFF?text=First+3D+Print", alt: "First 3D Print Experience" },
            { src: "https://via.placeholder.com/800x400/4CAF50/FFFFFF?text=LEGO+Mindstorms+Robot", alt: "LEGO Mindstorms Projects" }
        ]
    },
    genesis: {
        ...
        images: [
            ...
            { src: "https://via.placeholder.com/800x400/4CAF50/FFFFFF?text=Arduino+Programming+Setup", alt: "Arduino Programming" },
            { src: "https://via.placeholder.com/800x400/9C27B0/FFFFFF?text=First+Robotic+Arm", alt: "4-DOF Robotic Arm" },
            { src: "https://via.placeholder.com/800x400/FF9800/FFFFFF?text=Republic+Attack+Cruiser", alt: "3D Printed Star Wars Models" }
        ]
    },
    "science-fair": {
        ...
        images: [
            ...
            { src: "https://via.placeholder.com/800x400/E91E63/FFFFFF?text=VR+Pain+Management+Demo", alt: "VR Headset Demo" },
            { src: "https://via.placeholder.com/800x400/3F51B5/FFFFFF?text=Johns+Hopkins+Lab", alt: "Research Setup" },
            { src: "https://via.placeholder.com/800x400/FFC107/FFFFFF?text=Award+Ceremony", alt: "Science Fair Victory" }
        ]
    },
    zainiac19: {
    ...
    "world-tour": {
        ...
        images: [
            ...
            { src: "https://via.placeholder.com/800x400/2196F3/FFFFFF?text=Philadelphia+Maker+Faire", alt: "Philadelphia" },
            { src: "https://via.placeholder.com/800x400/4CAF50/FFFFFF?text=Rochester+Demo", alt: "Rochester" },
            { src: "https://via.placeholder.com/800x400/FF5722/FFFFFF?text=Brussels+Opening+Ceremony", alt: "Brussels Opening" }
        ]
    },
    "covid-response": {
        ...
        images: [
            { src: "https://via.placeholder.com/800x400/F44336/FFFFFF?text=COVID+Response+Project", alt: "COVID Response" },
            { src: "https://via.placeholder.com/800x400/9C27B0/FFFFFF?text=3D+Printing+Operation", alt: "3D Printing Lab" },
            { src: "https://via.placeholder.com/800x400/4CAF50/FFFFFF?text=N95+Mask+Design", alt: "Mask Design" },
            { src: "https://via.placeholder.com/800x400/FF9800/FFFFFF?text=Hospital+Donation", alt: "Cancer Center Donation" }
        ]
    },
    zainiac21: {
        ...
        images: [
            ...
            { src: "https://via.placeholder.com/800x400/673AB7/FFFFFF?text=Neural+Network+Training", alt: "AI Neural Network" },
            { src: "https://via.placeholder.com/800x400/00BCD4/FFFFFF?text=Advanced+Sensor+Array", alt: "Advanced Sensors" },
            { src: "https://via.placeholder.com/800x400/795548/FFFFFF?text=LBot+for+Lawrenceville", alt: "LBot Prototype" }
        ]
    },
    oxford: {
        ...
        images: [
            ...
            { src: "https://via.placeholder.com/800x400/1A237E/FFFFFF?text=Oxford+Engineering+Lab", alt: "Oxford Lab" },
            { src: "https://via.placeholder.com/800x400/388E3C/FFFFFF?text=Research+Publications", alt: "Research Papers" },
            { src: "https://via.placeholder.com/800x400/D32F2F/FFFFFF?text=Academic+Recognition", alt: "Academic Achievement" }
        ]
    },
    "flight-simulator": {
        ...
        images: [
            ...
            { src: "https://via.placeholder.com/800x400/607D8B/FFFFFF?text=3D+Printed+Cockpit", alt: "Custom Cockpit" },
            { src: "https://via.placeholder.com/800x400/FF5722/FFFFFF?text=Control+Systems", alt: "Flight Controls" },
            { src: "https://via.placeholder.com/800x400/9C27B0/FFFFFF?text=Flight+Physics+Engine", alt: "Software Development" }
        ]
    },
    princeton: {
        ...
        images: [
            ...
            { src: "https://via.placeholder.com/800x400/FF6F00/FFFFFF?text=Princeton+Research+Lab", alt: "Princeton Lab" },
            { src: "https://via.placeholder.com/800x400/1976D2/FFFFFF?text=Materials+Characterization", alt: "Lab Experiments" },
            { src: "https://via.placeholder.com/800x400/388E3C/FFFFFF?text=Research+Presentation", alt: "Research Presentation" }
        ]
    },
    leadership: {
        ...
        images: [
            { src: "https://via.placeholder.com/800x400/3F51B5/FFFFFF?text=Leadership+Team", alt: "Student Leadership" },
            { src: "https://via.placeholder.com/800x400/E91E63/FFFFFF?text=Robotics+Competition+2025", alt: "Robotics Competition" },
            { src: "https://via.placeholder.com/800x400/00BCD4/FFFFFF?text=Club+Meetings", alt: "Club Leadership" },
            { src: "https://via.placeholder.com/800x400/4CAF50/FFFFFF?text=Mentoring+Sessions", alt: "Student Mentoring" }
        ]
    }
};
